...
{\color{incolor}In [{\color{incolor}2}]:} \PY{k+kn}{import} \PY{n+nn}{matplotlib}\PY{n+nn}{.}\PY{n+nn}{pyplot} \PY{k}{as} \PY{n+nn}{plt}
        ...
        \PY{n}{sign} \PY{o}{=} \PY{n}{theta}\PY{n+nd}{@X}\PY{o}{.}\PY{n}{T}
        \PY{n}{X\PYZus{}neg} \PY{o}{=} \PY{n}{X}\PY{p}{[}\PY{n}{np}\PY{o}{.}\PY{n}{where}\PY{p}{(}\PY{n}{sign}\PY{o}{\PYZlt{}}\PY{l+m+mi}{0}\PY{p}{)}\PY{p}{]}
        \PY{n}{X\PYZus{}pos} \PY{o}{=} \PY{n}{X}\PY{p}{[}\PY{n}{np}\PY{o}{.}\PY{n}{where}\PY{p}{(}\PY{n}{sign}\PY{o}{\PYZgt{}}\PY{o}{=}\PY{l+m+mi}{0}\PY{p}{)}\PY{p}{]}
...
\end{enumerate}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}4}]:} \PY{k}{def} \PY{n+nf}{filter\PYZus{}classes}\PY{p}{(}\PY{n}{X}\PY{p}{,} \PY{n}{y}\PY{p}{,} \PY{n}{cls1}\PY{p}{,} \PY{n}{cls2}\PY{p}{)}\PY{p}{:}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}5}]:} \PY{c+c1}{\PYZsh{}Load data}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}6}]:} Text(0.5,0,'k')
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}8}]:} \PY{c+c1}{\PYZsh{}ii) Evaluate classifier accuracy using the test set }
...
Test Error:    0.0445
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}9}]:} \PY{c+c1}{\PYZsh{}iii) Compare the accuracy of your classifier }
...
\texttt{python\ \ \ \ \ trainMatrix,\ tokenlist,\ trainCategory\ =\ readMatrix(\textquotesingle{}MATRIX.TRAIN\textquotesingle{})\ \ \ \ \ testMatrix,\ tokenlist,\ testCategory\ =\ readMatrix(\textquotesingle{}MATRIX.TEST\textquotesingle{})}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}140}]:} \PY{k+kn}{import} \PY{n+nn}{read\PYZus{}spam\PYZus{}data} \PY{k}{as} \PY{n+nn}{rsd}
          \PY{k+kn}{from} \PY{n+nn}{sklearn}\PY{n+nn}{.}\PY{n+nn}{svm} \PY{k}{import} \PY{n}{LinearSVC}
...
in http://proceedings.mlr.press/v3/chang08a/chang08a.pdf
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}148}]:} \PY{c+c1}{\PYZsh{}i)}
          \PY{k+kn}{import} \PY{n+nn}{numpy} \PY{k}{as} \PY{n+nn}{np}
...
[ 0.41427361  0.41171377 -0.36579293  0.27131702 -0.25575369  0.24923277
  0.23578956  0.23437205  0.2304037   0.22636743]
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}149}]:} \PY{c+c1}{\PYZsh{}ii)}
...
[ 0.41427361  0.41171377 -0.36579293  0.27131702 -0.25575369  0.24923277
 ...
 -0.1778779  -0.17268974]
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}150}]:} \PY{n}{n} \PY{o}{=} \PY{n}{trainMatrix}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}
...
training time 10-fold.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}180}]:} \PY{k+kn}{from} \PY{n+nn}{sklearn}\PY{n+nn}{.}\PY{n+nn}{svm} \PY{k}{import} \PY{n}{SVC}
          \PY{k+kn}{from} \PY{n+nn}{matplotlib} \PY{k}{import} \PY{n}{rc}
          ...
          \PY{k}{for} \PY{n}{c} \PY{o+ow}{in} \PY{n}{C}\PY{p}{:}
              \PY{k}{for} \PY{n}{g} \PY{o+ow}{in} \PY{n}{gamma}\PY{p}{:}
                  \PY{n}{X\PYZus{}train}\PY{p}{,} \PY{n}{y\PYZus{}train} \PY{o}{=} \PY{n}{rand\PYZus{}data}\PY{p}{(}\PY{n}{data}\PY{p}{,}\PY{n}{n}\PY{p}{,}\PY{n+nb}{int}\PY{p}{(}\PY{l+m+mi}{1000}\PY{o}{*}\PY{p}{(}\PY{n}{g}\PY{o}{+}\PY{n}{c}\PY{p}{)}\PY{p}{)}\PY{p}{)}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
c= 1 gamma= 0.1 0.8696
c= 1 gamma= 0.01 0.9507
c= 1 gamma= 0.001 0.9071
c= 10 gamma= 0.1 0.844
c= 10 gamma= 0.01 0.9578
c= 10 gamma= 0.001 0.9331
c= 100 gamma= 0.1 0.8504
c= 100 gamma= 0.01 0.9596
c= 100 gamma= 0.001 0.9339

    \end{Verbatim}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}181}]:} \PY{c+c1}{\PYZsh{}Hér ætlum við að þjálfa rbf með bestu gildum á C og gamma:}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}185}]:} \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Test score:}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n+nb}{round}\PY{p}{(}\PY{n}{testScore}\PY{p}{,}\PY{l+m+mi}{4}\PY{p}{)}\PY{p}{)}
